...
This module is copied from Python-2.6.9/Lib/zipfile.py , for StaticPython.
It has fewer dependencies (i.e. no `import io', `import shutil')
than the one in Python 2.7.
"""
